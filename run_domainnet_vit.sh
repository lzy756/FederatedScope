...
# 定义要执行的命令数组
commands[1]="python federatedscope/main.py --cfg ./scripts/test/domainnet_vit/ditto_vit.yaml"
commands[2]="python federatedscope/main.py --cfg ./scripts/test/domainnet_vit/fedavg_vit.yaml"
commands[3]="python federatedscope/main.py --cfg ./scripts/test/domainnet_vit/fedprox_vit.yaml"
commands[4]="python federatedscope/main.py --cfg ./scripts/test/domainnet_vit/local_vit.yaml"
commands[5]="python federatedscope/main.py --cfg ./scripts/test/domainnet_vit/pFedMe_vit.yaml"
commands[6]="python federatedscope/main.py --cfg ./scripts/test/domainnet_vit/ours_vit.yaml"
