...
# 定义要执行的命令数组
commands[1]="python federatedscope/main.py --cfg ./scripts/test/office_31_alexnet/fdse_alexnet.yaml"
commands[2]="python federatedscope/main.py --cfg ./scripts/test/office_31_alexnet/fedavg_alexnet.yaml"
commands[3]="python federatedscope/main.py --cfg ./scripts/test/office_31_alexnet/fedprox_alexnet.yaml"
commands[4]="python federatedscope/main.py --cfg ./scripts/test/office_31_alexnet/local_alexnet.yaml"
commands[5]="python federatedscope/main.py --cfg ./scripts/test/office_31_alexnet/pFedMe_alexnet.yaml"
commands[6]="python federatedscope/main.py --cfg ./scripts/test/office_31_alexnet/ditto_alexnet.yaml"
...
# tmux 会话名称
session_name="federated_exp_office_31_alexnet"
